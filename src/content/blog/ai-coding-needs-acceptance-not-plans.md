...
date: '2026-07-08'
description: 'AI 编码真正需要补上的，不是更长的计划，而是一层能让人判断完成、让 agent 每次只推进一个缺口并在关键决策处停下来的验收契约。'
tags: ['AI协作', 'Agent工作流', 'OpenNori', '方法论']
---

# AI 编码缺的不是计划，而是验收

我最近做 OpenNori 时，越来越确定一件事：
...
这就是我想放进 OpenNori 里的 Loop Engineer 思想。
